...
IG=c(53,55)	
FEAGRI=c(8)
Outros=c(98,92,83, 200, 36, 60, 89)
FE=c(38)
```
...
mediaSim = c()
mediaNao = c()
for(i in 1:length(graduacoes$codigo)){
    mediaSim[i] = round(graduacoes[i,5]/graduacoes[i,4], 2)
    mediaNao[i] = round(graduacoes[i,6]/graduacoes[i,4], 2)
    }
graduacoes[, "Média Sim"] = mediaSim
graduacoes[, "Média Não"] = mediaNao
```
