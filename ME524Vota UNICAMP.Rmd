...
#Teste de Hipotese para proporçao de votos no Imecc

  Como visto nas últimas semanas o Instituto De Matemática-Estatística e Computação Científica foi fortemente afetado pelos piquetes(nao sei se e assim que se escreve), manifestçoẽs e também por quentes discussoẽs por parte dos docentes do instituto, que queriam ministrar suas aulas para alunos que tinham interesse nas mesmas e alegavam nao ser a favor da greve, com os grevistas que com piquetes impediam os mesmos de exercerem suas atividades, alegando que estariam "desrepeitando" o movimento grevista. 
  Para verificar a posicao dos alunos do instituto em relação a greve vamos utilizar o mesmo procedimento estatístico que foi utilizado para o geral da Unicamp. 
  Iremos definir como:
  
  -$p_{simImecc}$ como a proporção de votos sim do Imecc
  
  -$p_{naoImecc}$ como a proporção de votos nao do Iemcc
...
Após realizarmos o teste podemos observar que a estatística do teste apresenta o valor de `r estatTesteImecc` que é maior que o nosso valor z, que é `r zobs`, o que nos leva a rejeitar a hipóteste nula.  Enquanto o valor da estatitstica do teste for maior que o $z_{obs}$ iremos rejeitar a hipótese nula, ou seja rejeitar o fato que a proporção de votos não é menor que a de votos sim.
